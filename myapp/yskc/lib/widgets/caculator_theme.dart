...
import 'package:yskc/widgets/caculator.dart';
...
class _SimpleCalculatorState extends State<SimpleCalculator> {
  ...
  void _initController() {
    ...
    _controller.addListener(_didChangeCaleValue);
  }
  ...
  void dispose() {
    ...
    _controller.removeListener(_didChangeCaleValue);
    super.dispose();
  }
  ...
  void _didChangeCaleValue() {
    if (_eqLabel == _controller._eqLabel) return;
    setState(() {
      _eqLabel = _controller._eqLabel;
    });
  }
  ...
  List<List<GridButtonItem>> _getItems() {
    return [
      ...
      [_nums[7], _nums[8], _nums[9], "cal"],
      [_nums[4], _nums[5], _nums[6], "+"],
      [_nums[1], _nums[2], _nums[3], "-"],
      [_controller.numberFormat.symbols.DECIMAL_SEP, _nums[0], "del", _eqLabel],
    ].map((items) {
...
class _CalcDisplayState extends State<_CalcDisplay> {
  ...
  void initState() {
    ...
    widget.controller.addListener(_didChangeCaleValue);
  }
  ...
  void didUpdateWidget(_CalcDisplay oldWidget) {
    ...
    if (widget.controller != oldWidget.controller) {
      oldWidget.controller.removeListener(_didChangeCalcValue);
      widget.controller.addListener(_didChangeCalcValue);
      oldWidget.controller.removeListener(_didChangeCaleValue);
      widget.controller.addListener(_didChangeCaleValue);
    }
  }
  ...
  void dispose() {
    ...
    widget.controller.removeListener(_didChangeCaleValue);
    super.dispose();
  }
